...
if (selected == 'Bigmart sales prediction'):
    ...
    if ok: 
        x = Item_Weight, Item_Fat_Content, Item_Visibility, Item_Type, Item_MRP, Outlet_Establishment_Year, Outlet_Size, Outlet_Location_Type, Outlet_Type
        ...
        mart_sel_pred = bigmart_sales_prediction.predict(x_scaled)
        #f'The predicted present car price is:{car_predict}in thousand USD ($)'
...
if (selected == "Diabetes prediction"):
    ...
    if st.button("Submit and Predict"):
        ...
        diabetes_predict = diabetes_prediction.predict(x_scaled)                          
